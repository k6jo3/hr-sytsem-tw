...
import { useTemplates } from '@features/document/hooks';
import { DocumentApi } from '@features/document/api';
import type { DocumentTemplateViewModel } from '@features/document/model/DocumentViewModel';
import type { TemplateType } from '@features/document/api/DocumentTypes';
    ...
    <div style={{ padding: 24 }}>
      ...
      >
        <Form form={form} layout="vertical" style={{ marginTop: 16 }}>
          ...
          >
            <Input
              placeholder="例如：EMPLOYMENT_CERT"
