...
/**
 * 專案成本分析讀模型 Repository
 * 
 * @author SA Team
 * @since 2026-01-29
 */
@Repository
public interface ProjectCostAnalysisReadModelRepository
                extends JpaRepository<ProjectCostAnalysisReadModel, String>,
                IQueryRepository<ProjectCostAnalysisReadModel, String> {
}
