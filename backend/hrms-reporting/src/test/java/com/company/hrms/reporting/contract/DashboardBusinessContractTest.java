...
class DashboardBusinessContractTest extends BaseContractTest {
        ...
        class UserDashboardQueryContractTests {
                ...
                void RPT_DASH_001_QueryUserDashboards() throws IOException {
                        ...
                        QueryGroup query = QueryBuilder.where()
                                        .eq("tenantId", "T001")
                                        .eq("ownerId", UUID.fromString("11111111-1111-1111-1111-111111111111"))
                                        .build();
                ...
                void RPT_DASH_001a_UserQueryShouldIncludeTenantIsolation() {
                        ...
                        QueryGroup queryWithTenant = QueryBuilder.where()
                                        .eq("tenantId", "T001")
                                        .eq("ownerId", UUID.fromString("22222222-2222-2222-2222-222222222222"))
                                        .build();
                        ...
                        // When
                        Page<Dashboard> resultWithTenant = dashboardRepository.findPage(queryWithTenant,
                                        PageRequest.of(0, 100));
                        Page<Dashboard> resultWithoutTenant = dashboardRepository.findPage(queryWithoutTenant,
                                        PageRequest.of(0, 100));
        ...
        class TenantIsolationContractTests {
                ...
                void RPT_ISO_002_DataIsolationBetweenTenants() {
                        ...
                        // When
                        Page<Dashboard> t001Dashboards = dashboardRepository.findPage(queryT001,
                                        PageRequest.of(0, 100));
                        Page<Dashboard> t002Dashboards = dashboardRepository.findPage(queryT002,
                                        PageRequest.of(0, 100));
                        Page<Dashboard> t003Dashboards = dashboardRepository.findPage(queryT003,
                                        PageRequest.of(0, 100));
        ...
        class PermissionFilterContractTests {
                ...
                void RPT_PERM_001_NonOwnerCanOnlySeePublicDashboards() {
                        ...
                        QueryGroup query = QueryBuilder.where()
                                        .eq("tenantId", "T001")
                                        .eq("isPublic", true)
                                        .ne("ownerId", UUID.fromString(currentUserId))
                                        .build();
                ...
                void RPT_PERM_002_OwnerCanSeeAllOwnDashboards() {
                        ...
                        QueryGroup query = QueryBuilder.where()
                                        .eq("tenantId", "T001")
                                        .eq("ownerId", UUID.fromString(currentUserId))
                                        .build();
