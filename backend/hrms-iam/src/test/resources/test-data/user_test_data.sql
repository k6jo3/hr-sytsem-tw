...
-- 管理員 (使用預設租戶)
('user-001', 'admin', 'admin.unique@company.com', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/X4x5H5.8qGvhXHHe.', '管理員', '00000000-0000-0000-0000-000000000001', 'ACTIVE', FALSE),
-- 停用使用者
...
('ur-test-001', 'user-001', 'ROLE-001'),
('ur-test-002', 'test-user-001', 'ROLE-001');
