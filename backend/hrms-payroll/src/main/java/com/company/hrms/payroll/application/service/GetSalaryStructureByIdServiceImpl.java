 ...
 * </p>
 */
@Service("getSalaryStructureByIdServiceImpl")
@Transactional(readOnly = true)
@RequiredArgsConstructor
public class GetSalaryStructureByIdServiceImpl extends AbstractQueryService<String, SalaryStructureResponse> {
    ...
    @Override
    protected SalaryStructureResponse executeQuery(QueryGroup query, String id, JWTModel currentUser, String... args)
            throws Exception {
        ...
        SalaryStructure structure = repository.findById(new StructureId(targetId))
                .orElseThrow(() -> new DomainException("SALARY_STRUCTURE_NOT_FOUND", "找不到薪資結構: " + targetId));
