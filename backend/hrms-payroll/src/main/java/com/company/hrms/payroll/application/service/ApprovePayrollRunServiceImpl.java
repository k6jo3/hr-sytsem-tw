...
public class ApprovePayrollRunServiceImpl extends AbstractCommandService<PayrollRunActionRequest, PayrollRunResponse> {
    ...
    protected PayrollRunResponse doExecute(PayrollRunActionRequest request, JWTModel currentUser, String... args)
        ...
        // 1. 建立 Context
        PayrollRunActionContext context = new PayrollRunActionContext(request, currentUser, "APPROVE");
