...
class PayrollRunApiTest extends BaseApiContractTest {
        ...
        class PayrollRunLifecycleApiTests {
                ...
                void startPayrollRun_ShouldReturnRunIdAndDraftStatus() throws Exception {
                        ...
                        request.setPayDate(LocalDate.of(2025, 2, 5));
                        request.setName("2025-01 Monthly Payroll");
                ...
                void calculatePayroll_ShouldReturnCalculatedStatus() throws Exception {
                        ...
                        when(calculatePayrollService.execCommand(any(CalculatePayrollRequest.class),
                                        any(JWTModel.class), anyString()))
                                        .thenReturn(response);
                ...
                void submitPayrollRun_ShouldReturnPendingApprovalStatus() throws Exception {
                        ...
                        when(submitPayrollRunService.execCommand(any(PayrollRunActionRequest.class),
                                        any(JWTModel.class), anyString()))
                                        .thenReturn(response);
                ...
                void approvePayrollRun_ShouldReturnApprovedStatus() throws Exception {
                        ...
                        when(approvePayrollRunService.execCommand(any(PayrollRunActionRequest.class),
                                        any(JWTModel.class), anyString()))
                                        .thenReturn(response);
                ...
                void rejectPayrollRun_ShouldReturnRejectedStatus() throws Exception {
                        ...
                        when(rejectPayrollRunService.execCommand(any(PayrollRunActionRequest.class),
                                        any(JWTModel.class), anyString()))
                                        .thenReturn(response);
                ...
                void markPayrollRunPaid_ShouldReturnPaidStatus() throws Exception {
                        ...
                        when(markPayrollRunPaidService.execCommand(any(PayrollRunActionRequest.class),
                                        any(JWTModel.class), anyString()))
                                        .thenReturn(response);
