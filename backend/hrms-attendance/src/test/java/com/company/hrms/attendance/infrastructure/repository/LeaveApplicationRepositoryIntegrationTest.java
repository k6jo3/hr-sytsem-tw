...
class LeaveApplicationRepositoryIntegrationTest {
    ...
    class FindByStatusTests {
        ...
        void findByStatus_Pending_ShouldReturnPendingApplications() {
            // When
            List<LeaveApplication> result = leaveApplicationRepository.findByStatus(ApplicationStatus.PENDING);
        ...
        void findByStatus_Approved_ShouldReturnApprovedApplications() {
            // When
            List<LeaveApplication> result = leaveApplicationRepository.findByStatus(ApplicationStatus.APPROVED);
        ...
        void findByStatus_Rejected_ShouldReturnRejectedApplications() {
            // When
            List<LeaveApplication> result = leaveApplicationRepository.findByStatus(ApplicationStatus.REJECTED);
            ...
            assertThat(result)
                    .as("駁回申請應有駁回原因")
                    .allMatch(app -> app.getRejectionReason() != null && !app.getRejectionReason().isEmpty());
        }
        ...
        void findByStatus_Cancelled_ShouldReturnCancelledApplications() {
            // When
            List<LeaveApplication> result = leaveApplicationRepository.findByStatus(ApplicationStatus.CANCELLED);
    ...
    class FindByEmployeeIdAndDateRangeTests {
        ...
        void findByEmployeeIdAndDateRange_E001_January_ShouldReturnApplications() {
            ...
            assertThat(result)
                    ...
                    .hasSize(3)
                    .allMatch(app -> "E001".equals(app.getEmployeeId()))
                    .allMatch(app -> !app.getStartDate().isBefore(startDate) && !app.getEndDate().isAfter(endDate));
        }
        ...
        void findByEmployeeIdAndDateRange_E002_January_ShouldReturnApplications() {
            ...
            // Then
            assertThat(result)
                    .as("E002 一月份應有 3 筆請假申請 (LA006, LA009, LA011)")
                    .hasSize(3)
                    .allMatch(app -> "E002".equals(app.getEmployeeId()));
        }
    ...
    class EmployeeIsolationTests {
        ...
        void statusIsolation_DataShouldNotOverlap() {
            // When
            List<LeaveApplication> pending = leaveApplicationRepository.findByStatus(ApplicationStatus.PENDING);
            List<LeaveApplication> approved = leaveApplicationRepository.findByStatus(ApplicationStatus.APPROVED);
            List<LeaveApplication> rejected = leaveApplicationRepository.findByStatus(ApplicationStatus.REJECTED);
            List<LeaveApplication> cancelled = leaveApplicationRepository.findByStatus(ApplicationStatus.CANCELLED);
    ...
    class SpecificScenarioTests {
        ...
        void sickLeaveApplications_ShouldHaveAttachment() {
            ...
            Optional<LeaveApplication> sickLeave1 = leaveApplicationRepository.findById(new ApplicationId("LA002"));
            Optional<LeaveApplication> sickLeave2 = leaveApplicationRepository.findById(new ApplicationId("LA006"));
        ...
        void halfDayLeave_ShouldHaveCorrectPeriod() {
            ...
            Optional<LeaveApplication> morningLeave = leaveApplicationRepository.findById(new ApplicationId("LA003"));
            Optional<LeaveApplication> afternoonLeave = leaveApplicationRepository.findById(new ApplicationId("LA007"));
