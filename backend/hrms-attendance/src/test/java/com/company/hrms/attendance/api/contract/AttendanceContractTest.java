...
import com.company.hrms.attendance.domain.event.AnnualLeaveExpiringEvent;
import com.company.hrms.attendance.domain.event.AttendanceAnomalyDetectedEvent;
import com.company.hrms.attendance.domain.event.AttendanceMonthClosedEvent;
...
import com.company.hrms.attendance.domain.event.LeaveApprovedEvent;
import com.company.hrms.attendance.domain.event.LeaveCancelledEvent;
import com.company.hrms.attendance.domain.event.LeaveRejectedEvent;
...
import com.company.hrms.attendance.domain.event.OvertimeLimitExceededEvent;
...
public class AttendanceContractTest extends BaseContractTest {
        ...
        class AttendanceCommandTests {
                ...
                void checkIn_ATT_CMD_A001() throws Exception {
                        ...
                        List<Map<String, Object>> capturedEvents = convertDomainEventsToMaps(
                                        eventCaptor.getCapturedEvents());
        ...
        class ShiftCommandTests {
                ...
                void createShift_ATT_CMD_S001() throws Exception {
                        ...
                        Map<String, List<Map<String, Object>>> beforeSnapshot = captureDataSnapshot("shifts");
                        ...
                        Map<String, List<Map<String, Object>>> afterSnapshot = captureDataSnapshot("shifts");
        ...
        class LeaveTypeCommandTests {
                ...
                void createLeaveType_ATT_CMD_T001() throws Exception {
                        ...
                        Map<String, List<Map<String, Object>>> beforeSnapshot = captureDataSnapshot("leave_types");
                        ...
                        Map<String, List<Map<String, Object>>> afterSnapshot = captureDataSnapshot("leave_types");
                ...
                void deactivateLeaveType_ATT_CMD_T003() throws Exception {
                        ...
                        var result = mockMvc.perform(
                                        put("/api/v1/leave/types/" + AttendanceTestData.LEAVE_TYPE_PERSONAL
                                                        + "/deactivate"))
                                        .andReturn();
