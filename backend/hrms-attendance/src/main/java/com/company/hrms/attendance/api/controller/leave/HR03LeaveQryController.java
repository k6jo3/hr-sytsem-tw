...
public class HR03LeaveQryController extends QueryBaseController {
        ...
        public ResponseEntity<PageResponse<LeaveApplicationListResponse>> getLeaveApplications(
                ...
                LeaveApplicationQueryRequest request = new LeaveApplicationQueryRequest(
                                employeeId, departmentId, leaveTypeId, status, startDate, endDate, page, size);
