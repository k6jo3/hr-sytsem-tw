...
class SendNotificationServiceIntegrationTest {
        ...
        void scenario1_DirectSend_ShouldSucceed() throws Exception {
                ...
                Optional<Notification> savedNotification = notificationRepository
                                .findById(NotificationId.of(response.getNotificationId()));
        ...
        void scenario6_BusinessRelation_ShouldBeSetCorrectly() throws Exception {
                ...
                assertThat(savedNotification.get().getRelatedBusinessUrl())
                                .isEqualTo("/attendance/leave/applications/leave-001");
        }
}
