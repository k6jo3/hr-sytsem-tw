...
-- employeeId 必須對應 Organization 服務中真實的員工 ID
-- 員工1 (陳志強/總經理):  e1000000-0000-0000-0000-000000000001
-- 員工2 (林雅婷/專案經理): e2000000-0000-0000-0000-000000000002
-- 員工3 (王小明/資深工程師): e3000000-0000-0000-0000-000000000003
-- ============================================================================
...
-- ===== 加退保記錄 =====
-- 員工1 (陳志強/總經理): 勞保 ACTIVE + 健保 ACTIVE
...
('00000000-0000-0000-5000-000000000101', 'e1000000-0000-0000-0000-000000000001', '00000000-0000-0000-5000-000000000001', 'LABOR',  '2025-01-15', NULL, '00000000-0000-0000-5000-000000000012', 28800.00, 'ACTIVE', TRUE,  TIMESTAMP '2025-01-16 10:00:00', TIMESTAMP '2025-01-15 09:00:00', TIMESTAMP '2025-01-16 10:00:00'),
('00000000-0000-0000-5000-000000000102', 'e1000000-0000-0000-0000-000000000001', '00000000-0000-0000-5000-000000000001', 'HEALTH', '2025-01-15', NULL, '00000000-0000-0000-5000-000000000022', 28800.00, 'ACTIVE', TRUE,  TIMESTAMP '2025-01-16 10:00:00', TIMESTAMP '2025-01-15 09:00:00', TIMESTAMP '2025-01-16 10:00:00');

-- 員工2 (林雅婷/專案經理): 勞保 ACTIVE
INSERT INTO insurance_enrollments (enrollment_id, employee_id, insurance_unit_id, insurance_type, enroll_date, withdraw_date, insurance_level_id, monthly_salary, status, is_reported, reported_at, created_at, updated_at) VALUES
('00000000-0000-0000-5000-000000000103', 'e2000000-0000-0000-0000-000000000002', '00000000-0000-0000-5000-000000000001', 'LABOR',  '2025-02-01', NULL, '00000000-0000-0000-5000-000000000013', 30300.00, 'ACTIVE', TRUE,  TIMESTAMP '2025-02-02 09:00:00', TIMESTAMP '2025-02-01 09:00:00', TIMESTAMP '2025-02-02 09:00:00');

-- 員工3 (王小明/資深工程師): 勞保已退保
INSERT INTO insurance_enrollments (enrollment_id, employee_id, insurance_unit_id, insurance_type, enroll_date, withdraw_date, insurance_level_id, monthly_salary, status, is_reported, reported_at, created_at, updated_at) VALUES
('00000000-0000-0000-5000-000000000104', 'e3000000-0000-0000-0000-000000000003', '00000000-0000-0000-5000-000000000002', 'LABOR',  '2024-06-01', '2025-01-31', '00000000-0000-0000-5000-000000000011', 27470.00, 'WITHDRAWN', TRUE, TIMESTAMP '2025-02-01 09:00:00', TIMESTAMP '2024-06-01 09:00:00', TIMESTAMP '2025-02-01 09:00:00');
