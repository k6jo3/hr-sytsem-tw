...
import com.company.hrms.recruitment.application.task.candidate.UpdateCandidateStatusTask;
import com.company.hrms.recruitment.domain.model.aggregate.Candidate;

@Service("updateCandidateStatusServiceImpl")
public class UpdateCandidateStatusServiceImpl
        ...
        @Autowired
        private UpdateCandidateStatusTask updateTask;
