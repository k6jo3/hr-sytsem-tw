...
import com.company.hrms.recruitment.application.task.candidate.HireCandidateTask;
...
public class HireCandidateServiceImpl
    ...
    @Autowired
    private HireCandidateTask hireTask;
    ...
    public CandidateResponse execCommand(UpdateCandidateStatusRequest request, JWTModel currentUser, String... args)
        ...
        ctx.setRequest(request); // Might be null or empty
