...
public class GetTrainingStatisticsServiceImpl
    ...
    @Override
    public TrainingStatisticsResponse getResponse(TrainingStatisticsQuery query, JWTModel currentUser, String... args) {
        ...
        BigDecimal totalHours = enrollments.stream()
                .filter(e -> e.getStatus() == EnrollmentStatus.COMPLETED && e.getCompletedHours() != null)
