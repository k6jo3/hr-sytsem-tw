...
import com.company.hrms.training.application.service.task.course.PublishCourseTask;
...
public class PublishCourseServiceImpl implements CommandApiService<CourseActionRequest, Void> {

    private final LoadCourseActionTask loadCourseTask;
    private final PublishCourseTask publishCourseTask;
