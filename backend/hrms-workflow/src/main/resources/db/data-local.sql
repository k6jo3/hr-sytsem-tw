-- ============================================================================
-- HR11 Workflow Service - Local Seed Data (H2)
-- ============================================================================
...
('WF-TASK-001', 'WF-INS-001', 'mgr', '主管審核', '00000000-0000-0000-0000-000000000010', '陳經理', NULL, NULL, NULL, 'PENDING', CURRENT_TIMESTAMP, NULL, NULL, DATEADD('DAY', 3, CURRENT_TIMESTAMP), FALSE),
('WF-TASK-002', 'WF-INS-002', 'mgr', '主管審核', '00000000-0000-0000-0000-000000000010', '陳經理', NULL, NULL, '00000000-0000-0000-0000-000000000010', 'APPROVED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '同意', DATEADD('DAY', 3, CURRENT_TIMESTAMP), FALSE),
('WF-TASK-003', 'WF-INS-002', 'hr', 'HR確認', '00000000-0000-0000-0000-000000000020', 'HR王小姐', NULL, NULL, '00000000-0000-0000-0000-000000000020', 'APPROVED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '確認通過', DATEADD('DAY', 3, CURRENT_TIMESTAMP), FALSE),
('WF-TASK-004', 'WF-INS-003', 'mgr', '主管審核', '00000000-0000-0000-0000-000000000010', '陳經理', NULL, NULL, '00000000-0000-0000-0000-000000000010', 'REJECTED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '該日有重要會議，請改期', DATEADD('DAY', 3, CURRENT_TIMESTAMP), FALSE);
