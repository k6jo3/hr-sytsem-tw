...
@Transactional
public class StartProjectServiceImpl implements CommandApiService<StartProjectRequest, StartProjectResponse> {

    private final IProjectRepository projectRepository;

    @Override
    public StartProjectResponse execCommand(StartProjectRequest req, JWTModel currentUser, String... args)
            throws Exception {
        ...
        return new StartProjectResponse(true, project.getStatus().name());
    }
}
