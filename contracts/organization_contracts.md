...
**總計：24 個場景（13 個 Query + 11 個 Command）**
...
```json
{
  ...
  "request": {
    ...
    "parentOrganizationId": "11111111-1111-1111-1111-111111111111"
  },
  "businessRules": [
    {"rule": "code 必須唯一"},
    {"rule": "organizationType 須為 PARENT 或 SUBSIDIARY"},
    {"rule": "parentOrganizationId 若指定則必須存在"},
