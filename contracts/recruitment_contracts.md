...
| # | 端點 | 方法 | 場景 ID | 說明 | 實作狀態 |
|:---:|:---|:---:|:---|:---|:---:|
| 1 | `POST /api/v1/candidates` | POST | RCT_CMD_CD001 | 建立應徵者 | ✅ 已實作 |
| 2 | `PUT /api/v1/candidates/{id}/status` | PUT | RCT_CMD_CD002 | 更新應徵者狀態 | ✅ 已實作 |
| 3 | `PUT /api/v1/candidates/{id}/reject` | PUT | RCT_CMD_CD003 | 淘汰應徵者 | ✅ 已實作 |
| 4 | `PUT /api/v1/candidates/{id}/hire` | PUT | RCT_CMD_CD004 | 錄用應徵者 | ✅ 已實作 |
| 5 | `GET /api/v1/candidates` | GET | RCT_CD001~CD005 | 查詢應徵者列表 | ✅ 已實作 |
| 6 | `GET /api/v1/candidates/{id}` | GET | - | 查詢應徵者詳情 | ✅ 已實作 |
...
**API 端點：** `PUT /api/v1/candidates/{id}/status`
...
```json
{
  ...
  "apiEndpoint": "PUT /api/v1/candidates/{id}/status",
  "controller": "HR09CandidateCmdController",
...
**API 端點：** `PUT /api/v1/candidates/{id}/reject`
...
```json
{
  ...
  "apiEndpoint": "PUT /api/v1/candidates/{id}/reject",
  "controller": "HR09CandidateCmdController",
...
**API 端點：** `PUT /api/v1/candidates/{id}/hire`
...
```json
{
  ...
  "apiEndpoint": "PUT /api/v1/candidates/{id}/hire",
  "controller": "HR09CandidateCmdController",
