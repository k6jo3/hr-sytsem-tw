...
| `E-INT-03` | 評估按鈕 | onClick | 開啟評估表單 | - |
| `E-INT-04` | 評估確認 | onClick | 提交面試評估 | POST /api/v1/recruitment/interviews/{id}/evaluation |
| `E-INT-05` | 取消面試按鈕 | onClick | 取消面試 | PUT /api/v1/recruitment/interviews/{id}/cancel |
