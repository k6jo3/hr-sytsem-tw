...
1. [API 總覽](#1-api-總覽)
2. [組織管理 API](#2-組織管理-api)
3. [部門管理 API](#3-部門管理-api)
4. [員工管理 API](#4-員工管理-api)
5. [ESS 員工自助 API](#5-ess-員工自助-api)
6. [合約管理 API](#6-合約管理-api)
7. [附錄：列舉值定義](#7-附錄列舉值定義)
...
### 7.10 人事歷程事件類型 (HistoryEventType)
...
### 7.12 證明文件申請狀態 (CertificateRequestStatus)
